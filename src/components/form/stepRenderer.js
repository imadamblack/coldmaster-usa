      ...
      return (
        <div className="flex flex-col bg-brand-1/30 p-12 rounded-3xl">
          <div>
            ...
            {step.description && (
              <p className="ft-2 mt-4 text-brand-4" dangerouslySetInnerHTML={{ __html: step.description }} />
            )}
          </div>
          ...
          <div className="mt-4">
            <p className="-ft-3 text-brand-1">Your contact info will not be shared, on submit you agree to our&nbsp;
              <Link href={info.privacyNotice}>privacy notice</Link>
            </p>
          </div>
        </div>
      );
